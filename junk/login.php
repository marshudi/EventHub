        ...
        <form action="" method="post">
          <div class="form-group mb-6 ">
            ...
            <input type="text" class="form-control
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" naidme="username"
          ...
          <div class="form-group mb-6">
            ...
            <input type="password" class="form-control block
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="passwords"
          ...
          <input value="login" type="submit" id="login ="class="
            w-full
            px-6
            py-2.5
            bg-blue-600
...
<?php 
  ...
  && isset($_POST['login']))
  { 
  $sql = "SELECT * FROM `eventhub`.`user` WHERE userID='admin' and password='123'";
