        ...
        <form action="" method="post" <?php echo $_SERVER['PHP_SELF'];?>>
          <div class="form-group mb-6 ">
            ...
            <input type="text" class="form-control
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="username" id="username"
          ...
          <div class="form-group mb-6">
            ...
            <input type="password" class="form-control block
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="passwords" name="password"
...
<?php 
  ...
  $sql = "SELECT * FROM `eventhub`.`user` WHERE userID= :uid and password= :pwd";
  ...
  $n = $stmt-> rowCount();
  if (($n == 1) && ($_REQUEST["username"] === "admin"))
  {
  
  echo "<script>window.location.href='panel_admin.html'</script>";
  return;
  }
  else if($n == 1)
  {
    echo "<script>window.location.href='event_event.html'</script>";
  }
  else{
