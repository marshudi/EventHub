...
// if(isset($_REQUEST['login'])&& isset($_REQUEST['userID'])&& isset($_REQUEST['password']))
// { 


// $sql = "SELECT * FROM `eventhub`.`user` WHERE userID= :uid";
...
// if (($n == 1) && (decrypt($row['password']) == $_REQUEST['password'])) 
// {
//   //session_start();
                ...
                <div class="flex md:order-2">
                    ...
                    <button type="button"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4
                         ...
                         dark:hover:bg-green-700 dark:focus:ring-green-800" aria-current="page">Login</button>
        ...
        <form action="" method="post" <?php echo $_SERVER['PHP_SELF'];?>>
          <div class="form-group mb-6 ">
            <div class="col-md-12 text-center">
              <h3 class="animate-charcter"> Login</h3>
            </div>
            <br>

            <label for="exampleInputusername2" class="form-label inline-block mb-2 text-gray-700">username</label>
            <input type="text" class="form-control
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="userID" id="userID"
          ...
          <div class="form-group mb-6">
            ...
            <input type="password" class="form-control block
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="password" name="password"
          ...
          <input value="login" type="submit" id="login" name="login" class="
            w-full
            px-6
            py-2.5
            bg-blue-600
          ...
          <p class="text-gray-800 mt-6 text-center">Not a member? <a href="register.php"
              class="text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out text-sm">Register</a>
          </p>
        </form>
      </div>
...
<div id="login" class="tabcontent">
  ...
  <button class="tablink" onclick="openFunc('login', this, '#C5E1A5')" id="defaultOpen">Login</button>
  <button class="tablink" onclick="openFunc('register', this, '#B3E5FC')">Register New Account!</button>
  <button class="tablink" onclick="openFunc('forget', this, '#FFCCBC')">Forgot Password!</button>

  
  <script>
  function openFunc(functions,elmnt,color) {
...
<?php 
  ...
  include 'dbconnection.php';
  if(isset($_REQUEST['userID'])&& isset($_REQUEST['password'])&& isset($_REQUEST['login']))
  { 
...
//   && ((decrypt($row['password']) == $_REQUEST['password'])))
//   {
...
// }
  ...
  // if (($n == 1) && (password_verify($row['password'], $_REQUEST['password']))) {
  //   //    session_start();
  //       $_SESSION['username'] = $row['userID'];
  //       header("refresh:2;");
  //       header('Location: ' . 'event.html');
...
<?php 
    ...
    //     $uid= $_POST['userID'];
    //     $pwd= $_POST['password']
    //     $select=mysqli_query($conn,"SELECT * FROM user WHERE userID='$uid' AND password='$pwd'");
