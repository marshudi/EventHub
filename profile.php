...
<body>
  ...
  <h2 class="text-4xl font-medium leading-tight text-gray-800">
    View Your
    <span class="inline-block py-1.5 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded">Profile</span>
  </h2>
</div>
<br>
<div class="flex space-x-2 justify-center">
<h4 class="font-medium leading-tight text-2xl mt-0 mb-2 text-blue-600">Booked Tickets!</h4>
</div>
              ...
              <tbody>
                <tr>
                  <td class="hidden pb-4 md:table-cell">
                    <a href="#">
                      <img src="./Pictures/Business & Seminars/male-business-executive-giving-speech.jpg" class="w-20 rounded" alt="Thumbnail">
                    </a>
                  </td>
                  <td>
                    <a href="#">
                      <p class="mb-2 md:ml-4">Unravelling NFTs</p>
