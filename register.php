        ...
        <form id="lol" method="post" <?php echo $_SERVER['PHP_SELF']; ?>>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="form-group mb-6">
              <input type="text" class="form-control
                ...
                aria-describedby="emailHelp123" placeholder="First name" required pattern="[A-Za-z]{2,20}" title="please Enter a valid First Name">
            </div>
            ...
            <div class="form-group mb-6">
              <input type="text" class="form-control
                ...
                aria-describedby="emailHelp124" placeholder="Last name" required pattern="[A-Za-z]{2,20}" title="please Enter a valid Last Name">
            </div>
          </div>
          ...
          <div class="form-group mb-6">
            <input type="email" class="form-control block
              ...
              placeholder="Email address" required pattern=".{5,30}" title="Minimum of legnth 5,  'a@c.io'">
          </div>
          ...
          <div class="form-group mb-6 ">
            ...
            <input type="text" class="form-control
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="userID"
               placeholder="Enter username" required pattern=".{4,15}" title="Minimum of length 4 and Maximum of 15,  'abdu'">
          </div>
          ...
          <div class="form-group mb-6">
            <input type="password" class="form-control block
              ...
              placeholder="Password" required pattern=".{5,30}" title="Minimum Password length 5 and Maximum of 30">
          </div>
...
<?php
	...
	//code for insert new row
	if(isset($_REQUEST['submit']))
		if(!empty($_REQUEST['FirstName']) && !empty($_REQUEST['LastName']) &&
		!empty($_REQUEST['email']) && !empty($_REQUEST['userID']) && !empty($_REQUEST['password']) 
        && !empty($_REQUEST['ConfirmPassword']) && !empty($_REQUEST['birthdate']) && !empty($_REQUEST['gender'])
        ...
        echo $_REQUEST['nationality'];
				$sql = "INSERT INTO user(userID,FirstName,LastName,birthdate,gender,email,nationality,password)
					VALUES (:uid,:fname, :lname,:bd,:gdr, :em,:ntt,:pwd  )";
          ...
          return;
            ...
            {
              echo "<br>please enter the same password....!";
            }
